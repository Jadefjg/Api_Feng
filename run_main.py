...
def add_case(caseName="test_case", rule="test*.py"):
    ...
    print("test test_case path:%s"%case_path)
    # 定义discover方法的参数
...
def run_case(all_case, reportName="reports"):
    ...
    print("reports path:%s"%report_abspath)
...
def send_mail(sender, psw, receiver, smtpserver, report_file, port):
    ...
    att["Content-Disposition"] = 'attachment; filename= "reports.html"'
    msg.attach(att)
    try:
    ...
    smtp.quit()
    print('test reports email has send out !')
...
if __name__ == "__main__":
    ...
    # 获取最新的测试报告文件
    report_path = os.path.join(cur_path, "reports")  # 用例文件夹
